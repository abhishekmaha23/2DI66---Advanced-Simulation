...
@author: Marko Boon
---Modified to allow random_state and reproducibility
'''
...
class Distribution:
    ...
    def resample(self):
        # Random state allows reproducibility
        self.randomNumbers = self.dist.rvs(self.n, random_state=self.random_state)
        self.idx = 0
